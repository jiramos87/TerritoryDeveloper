...
| **Documentation** | reference spec, project spec, **IA index manifest**, **territory-compute-lib**, **interchange JSON**, **Dev repro bundle**, **Editor export registry**, **project-new**, **project-spec-close**, **project-implementation-validation**, **`validate:all`** (root **`npm run`**) |
...
| **Cliff suppression** | Hiding a cliff mesh when a shore ramp already shows the transition. One-step suppression toward water/water-shore on eligible shore cells; rim keeps a segment; `\|Δh\| ≥ 2` still stacks. | geo §5.6.1 |
...
| Term | Definition | Spec |
|------|-----------|------|
| **Geography initialization** | First-time map build on **New Game** — ordered pipeline from heightmap through water, rivers, interstate, forests, desirability, and sorting before play. `GeographyManager` orchestrates; order must stay consistent with save/load assumptions. | `ARCHITECTURE.md`, geo §12.1, mgrs |
...
| **Wet run** | Contiguous **water and/or water-slope** cells along a stroke that a bridge crosses in one straight segment. Truncation rules keep wet runs intact for FEAT-44. | geo §13.4, geo §14.5, roads |
...
| **Urbanization proposal** | **OBSOLETE** — legacy expansion proposal UI and manager; **never re-enable** (TECH-13). Not part of `UrbanCentroidService` / ring AUTO. | sim |
...
| **project-spec-close** | Cursor Agent Skill ([`project-spec-close/SKILL.md`](../skills/project-spec-close/SKILL.md)) that sequences **verified** closure: **persist IA** (checklist: glossary, reference specs, `ARCHITECTURE.md`, rules, `docs/`, MCP docs when applicable) → reconcile umbrella/sibling specs → **delete** the **project spec** → `npm run validate:dead-project-specs` → **BACKLOG** **Completed** only after **user** confirmation. **territory-ia** helpers (**TECH-58**, completed — [`BACKLOG.md`](../../BACKLOG.md) **§ Completed**): **`project_spec_closeout_digest`**, **`spec_sections`**, root **`closeout:worksheet`** / **`closeout:dependents`** / **`closeout:verify`**. Shipped **TECH-51** (completed); does **not** duplicate the **TECH-50** dead-spec-path scanner. | [PROJECT-SPEC-STRUCTURE.md](../projects/PROJECT-SPEC-STRUCTURE.md) **Closeout checklist**, `AGENTS.md`, [`BACKLOG.md`](../../BACKLOG.md) **§ Completed** **TECH-51**, **TECH-58** |
| **project-implementation-validation** | Cursor Agent Skill ([`project-implementation-validation/SKILL.md`](../skills/project-implementation-validation/SKILL.md)) with an ordered **validation manifest** of **existing** **`npm`** commands (**dead project spec** paths, **`tools/mcp-ia-server`** tests, **fixtures**, **`generate:ia-indexes --check`**, optional **`verify`**), aligned with **IA tools** **CI**. From repo root, **`npm run validate:all`** runs manifest steps 1–4 in one chain (does **not** embed **`npm ci`** — install **`tools/mcp-ia-server`** deps first if **`test:ia`** fails). **Failure policy:** stop on first failure. Does **not** replace **Unity** **Pre-commit** or reimplement **TECH-50**. Optional before **`project-spec-close`** step 8 when work touched **MCP** / **schemas** / index sources. Shipped **TECH-52** (completed); root aggregate **`validate:all`** shipped **TECH-61** (completed). | [`.github/workflows/ia-tools.yml`](../../.github/workflows/ia-tools.yml), root [`package.json`](../../package.json), `AGENTS.md`, [`docs/mcp-ia-server.md`](../../docs/mcp-ia-server.md), [`BACKLOG.md`](../../BACKLOG.md) **§ Completed** **TECH-52**, **TECH-61** |
| **territory-ia spec-pipeline program (TECH-60)** | **Completed** **BACKLOG** umbrella (**§ Spec pipeline & verification program**): phased **TECH-61** (layer A — **`validate:all`**, **project-implementation-validation**), **TECH-62** (**glossary** **territory-ia spec-pipeline layer B (TECH-62)**), **TECH-63** (**glossary** **territory-ia spec-pipeline layer C (TECH-63)**). **Exploration:** [`projects/spec-pipeline-exploration.md`](../../projects/spec-pipeline-exploration.md). **Prerequisites** for long-term **Unity** / **golden** / **invariant** verification (**TECH-15**, **TECH-16**, **TECH-31**, **TECH-35**, **TECH-30**, **TECH-37**, **TECH-38**) remain separate **BACKLOG** rows. **Charter decisions:** program ids **TECH-60**–**TECH-63**; three layers (scripts vs MCP vs **Skills**/template) vs one monolithic issue. | [`BACKLOG.md`](../../BACKLOG.md) **§ Completed** **TECH-60**–**TECH-63**, [`projects/spec-pipeline-exploration.md`](../../projects/spec-pipeline-exploration.md), [`.cursor/skills/README.md`](../skills/README.md), [`docs/mcp-ia-server.md`](../../docs/mcp-ia-server.md) |
| **territory-ia spec-pipeline layer B (TECH-62)** | **Completed** **BACKLOG** child under **TECH-60** (**glossary** **territory-ia spec-pipeline program (TECH-60)**): **`backlog_issue`** adds **`depends_on_status`** for each id cited on **Depends on:** (`open` / `completed` / `not_in_backlog`, `soft_only`, `satisfied`); **`router_for_task`** accepts **`domain`** and/or **`files`** (max 40 repo-relative paths) and may return **`file_domain_hints`**. Package **`@territory/mcp-ia-server`** **0.4.4**. **`context_bundle`**, **`spec_section`** **`include_children`**, **`project_spec_status`**: deferred — coordinate **TECH-48** / follow-ups. | [`docs/mcp-ia-server.md`](../../docs/mcp-ia-server.md), [`BACKLOG.md`](../../BACKLOG.md) **§ Completed** **TECH-62**, [`projects/spec-pipeline-exploration.md`](../../projects/spec-pipeline-exploration.md), **glossary** **territory-ia spec-pipeline program (TECH-60)** |
| **territory-ia spec-pipeline layer C (TECH-63)** | **Completed** **BACKLOG** child under **TECH-60** (**glossary** **territory-ia spec-pipeline program (TECH-60)**): **`## 7b. Test Contracts`** in [`.cursor/templates/project-spec-template.md`](../templates/project-spec-template.md); **Cursor Skills** (**kickoff**, **implement**, **close**, **new**, **project-implementation-validation**) document **`depends_on_status`** preflight, **`router_for_task`** **`files`**, **Impact preflight**, **Phase exit** / **Phase rollback**; **`AGENTS.md`** pre-**project spec** **§7b** pointer. **`project_spec_closeout_digest`** **`test_contracts`** extraction remains a **separate** **BACKLOG** follow-up (parser extension). | [`.cursor/projects/PROJECT-SPEC-STRUCTURE.md`](../projects/PROJECT-SPEC-STRUCTURE.md) **§7b**, [`.cursor/skills/README.md`](../skills/README.md), [`BACKLOG.md`](../../BACKLOG.md) **§ Completed** **TECH-63**, [`AGENTS.md`](../../AGENTS.md), **glossary** **territory-ia spec-pipeline program (TECH-60)** |
| **project-new** | Cursor Agent Skill ([`project-new/SKILL.md`](../skills/project-new/SKILL.md)) for **creating** a new [`BACKLOG.md`](../../BACKLOG.md) row and initial **`.cursor/projects/{ISSUE_ID}.md`** from a **user prompt**, using **territory-ia** MCP (**`glossary_discover`** → **`glossary_lookup`** → **`router_for_task`** → **`spec_section`**, then **`invariants_summary`** / **`backlog_issue`** when applicable) before file edits. **`backlog_issue`** returns **open** issues only — use [`BACKLOG-ARCHIVE.md`](../../BACKLOG-ARCHIVE.md) for **completed-only** id text. Optional **`web_search`** for **external** facts only; never overrides **glossary** / **reference specs** for in-repo rules. **Create-first** recipe order contrasts with **`project-spec-kickoff`** (review of an existing spec). Shipped **TECH-56** (completed). | `AGENTS.md`, [`.cursor/skills/README.md`](../skills/README.md), [`BACKLOG.md`](../../BACKLOG.md) **§ Completed** **TECH-56** |
| **IA index manifest** | Committed JSON under `tools/mcp-ia-server/data/`: **I1** (`spec-index.json`) lists each **reference spec** `key`, repo `path`, and heading `section_id` hints; **I2** (`glossary-index.json`) maps **glossary** **Term** → `spec_key` + `anchor`. Regenerate after editing `.cursor/specs/*.md` or `glossary.md`: `npm run generate:ia-indexes` from repo root. **CI** runs `generate:ia-indexes -- --check`. Complements **territory-ia** `spec_outline` / `spec_section` / `spec_sections`; does not replace file-backed tools. Shipped **TECH-40** (completed). | [`docs/mcp-ia-server.md`](../../docs/mcp-ia-server.md), [`docs/schemas/README.md`](../../docs/schemas/README.md), [REFERENCE-SPEC-STRUCTURE.md](REFERENCE-SPEC-STRUCTURE.md), [`BACKLOG.md`](../../BACKLOG.md) **§ Completed** **TECH-40** |
| **territory-compute-lib (TECH-37)** | TypeScript package at **`tools/compute-lib/`** (**npm** `territory-compute-lib`): **Zod** schemas and **pure** functions shared with **`tools/mcp-ia-server`** (`file:../compute-lib`). **C#** / **Unity** stay authoritative for **grid** truth; **Node** duplicates **only** math verified by **golden** tests under `tools/compute-lib/test/fixtures/`. **`dist/`** is emitted by **`npm run build`** (gitignored); **IA tools** **CI** runs **`npm ci && npm run build`** in **`tools/compute-lib`** before **`mcp-ia-server`** **`npm ci`**. Pilot **territory-ia** tool: **`isometric_world_to_grid`** (planar inverse per geo §1.3 code block; not height-aware picking). Shipped **TECH-37** (completed — [`BACKLOG.md`](../../BACKLOG.md) **§ Completed**). | [`docs/mcp-ia-server.md`](../../docs/mcp-ia-server.md), `tools/compute-lib/README.md`, geo §1.3, **glossary** **World ↔ Grid conversion** |
| **JSON program (TECH-21)** | Completed backlog **umbrella** (project charter removed after **project-spec-close**). Phased delivery: **TECH-40** / **TECH-41** / **TECH-44a** **§ Completed** — interchange schemas, **CI** **`validate:fixtures`**, **I1**/**I2**, **Geography initialization** / Editor exports, **Postgres interchange patterns** (**B1**/**B3**/**P5**). **Process:** do **not** change player **Save data** without a dedicated **BACKLOG** migration issue. **Brainstorm** FAQ / retained ideas: keep [`projects/TECH-21-json-use-cases-brainstorm.md`](../../projects/TECH-21-json-use-cases-brainstorm.md) aligned with shipped vs deferred rows when editing interchange docs. **B2** append-only JSON line log remains **TECH-43** (open). **TECH-18** may later make MCP IA **DB**-backed without dropping Markdown authoring. | [`BACKLOG.md`](../../BACKLOG.md) **§ Completed** **TECH-21**; [`docs/postgres-interchange-patterns.md`](../../docs/postgres-interchange-patterns.md); [`docs/mcp-ia-server.md`](../../docs/mcp-ia-server.md); [`projects/TECH-21-json-use-cases-brainstorm.md`](../../projects/TECH-21-json-use-cases-brainstorm.md), **Interchange JSON (artifact)** |
| **Interchange JSON (artifact)** | Tooling and config JSON that is **not** player **Save data**. Payloads carry string **`artifact`** (logical model id); optional integer **`schema_version`** when a consumer must branch without loading a schema file. **JSON Schema** (Draft 2020-12) and fixtures live under `docs/schemas/`; **`npm run validate:fixtures`** in **CI**. **Save data** / **Load pipeline** remain per **persistence-system**. **TECH-41** (completed — [`BACKLOG.md`](../../BACKLOG.md) **§ Completed**): optional **G4** load of **`geography_init_params`** from **`StreamingAssets`** on **`GeographyManager`**; **G1**/**G2** Editor exports (`world_snapshot_dev`, `terrain_cell_chunk`) under **`tools/reports/`**; Zod parity in **`tools/mcp-ia-server/src/schemas/geography-init-params-zod.ts`**; layering in **`ARCHITECTURE.md`** — **Interchange JSON**. | [`docs/schemas/README.md`](../../docs/schemas/README.md), [`docs/postgres-interchange-patterns.md`](../../docs/postgres-interchange-patterns.md), [`projects/TECH-21-json-use-cases-brainstorm.md`](../../projects/TECH-21-json-use-cases-brainstorm.md) **FAQ**, **persistence-system**, **`ARCHITECTURE.md`** |
| **Postgres interchange patterns (B1, B3, P5)** | Normative patterns for future **PostgreSQL** rows and HTTP/sync clients: **B1** (queryable scalars + **JSONB** payload), **B3** (idempotent **patch** **envelope** as a message contract), **P5** (streaming / large-document options), and SQL vs **Interchange JSON** naming. Does **not** replace player **Save data** or **Load pipeline** without a dedicated **BACKLOG** migration issue. Shipped as **TECH-44a** (completed — [`BACKLOG.md`](../../BACKLOG.md) **§ Completed**); first **IA** schema milestone **TECH-44b** (completed — same section): **`db/migrations/`**, [`docs/postgres-ia-dev-setup.md`](../../docs/postgres-ia-dev-setup.md). Merged **TECH-44** umbrella (completed — [`BACKLOG.md`](../../BACKLOG.md) **§ Completed** **TECH-44**); **E1**–**E3** backlog mapping: [`docs/postgres-interchange-patterns.md`](../../docs/postgres-interchange-patterns.md) **Program extension mapping (E1–E3)**. | [`docs/postgres-interchange-patterns.md`](../../docs/postgres-interchange-patterns.md), **persistence-system** §Save, [`docs/schemas/README.md`](../../docs/schemas/README.md), [`BACKLOG.md`](../../BACKLOG.md) **§ Completed** **TECH-44** |
| **Dev repro bundle** | **E1** dev registry: **Postgres** table **`dev_repro_bundle`** (**B1**) linking **Editor** exports under **`tools/reports/`** (**Agent context** JSON, optional **Sorting debug** Markdown) to **`backlog_issue_id`** and **`git_sha`**. **`payload jsonb`** carries **`artifact`**: `dev_repro_bundle`, **`schema_version`**: **1**, and repo-relative paths. **Write:** **`tools/postgres-ia/register-dev-repro.mjs`** / **`npm run db:register-repro`**; **read:** **`dev_repro_list_by_issue`**. **`normalizeIssueId`** in that script mirrors **`tools/mcp-ia-server`** **`backlog-parser.ts`** — keep in sync if rules change. Shipped **TECH-44c** (completed — [`BACKLOG.md`](../../BACKLOG.md) **§ Completed**). Distinct from per-export **Editor export registry** (**TECH-55**/**TECH-55b** **§ Completed**). | **unity-development-context** §10, [`docs/postgres-ia-dev-setup.md`](../../docs/postgres-ia-dev-setup.md), [`docs/postgres-interchange-patterns.md`](../../docs/postgres-interchange-patterns.md), [`db/migrations/0003_dev_repro_bundle.sql`](../../db/migrations/0003_dev_repro_bundle.sql) |
| **Editor export registry** | **Postgres** **B1** tables **`editor_export_*`** (migrations **`0004_editor_export_tables.sql`**, **`0005_editor_export_document.sql`**): one row per **Territory Developer → Reports** export family. **DB-first:** full body in **`document jsonb`** when **`DATABASE_URL`** resolves, schema is migrated (**`npm run db:migrate`**), and **`register-editor-export.mjs`** succeeds; otherwise the **Editor** writes **`tools/reports/`** only (**gitignored**). **`payload jsonb`** holds path/metadata (and interchange **`artifact`** keys where applicable). **Unity:** **`EditorPostgresExportRegistrar.TryPersistReport`**; **`node`** resolution uses **EditorPrefs**, **`NODE_BINARY`**, then **Volta**/**Homebrew**/Windows defaults when GUI **PATH** lacks **Node**. Optional **`backlog_issue_id`** in **EditorPrefs** (developer-entered **SQL** filter metadata; no backlog id as product branding in **Editor** UI). Shipped **TECH-55** + **TECH-55b** (completed — [`BACKLOG.md`](../../BACKLOG.md) **§ Completed**). **MCP** staging follow-up: **TECH-59** (open). | **unity-development-context** §10, [`docs/postgres-ia-dev-setup.md`](../../docs/postgres-ia-dev-setup.md) **Editor export registry**, [`docs/postgres-interchange-patterns.md`](../../docs/postgres-interchange-patterns.md) **Program extension mapping**, **`tools/postgres-ia/register-editor-export.mjs`** |
| **geography_init_params** | Interchange **`artifact`** for declarative **Geography initialization** (seed, map, optional water/rivers/forest sections). **C#:** **`Territory.Persistence.GeographyInitParamsDto`**, **`GeographyInitParamsLoader`**, optional **`GeographyManager.loadGeographyInitParamsFromStreamingAssets`**. **Contract:** [`docs/schemas/geography-init-params.v1.schema.json`](../../docs/schemas/geography-init-params.v1.schema.json); **Node** validation: **`tools/mcp-ia-server`** Zod + **`validate:fixtures`**. Not **Save data**. | **persistence-system**, **Geography initialization** (glossary), [`BACKLOG.md`](../../BACKLOG.md) **§ Completed** **TECH-41** |
