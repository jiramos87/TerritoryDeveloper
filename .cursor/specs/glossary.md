...
| **Documentation** | reference spec, project spec, **IA index manifest**, **interchange JSON**, **Dev repro bundle**, **Editor export registry**, **project-new**, **project-spec-close**, **project-implementation-validation** |
...
| **project-implementation-validation** | Cursor Agent Skill ([`project-implementation-validation/SKILL.md`](../skills/project-implementation-validation/SKILL.md)) with an ordered **validation manifest** of **existing** **`npm`** commands (**dead project spec** paths, **`tools/mcp-ia-server`** tests, **fixtures**, **`generate:ia-indexes --check`**, optional **`verify`**), aligned with **IA tools** **CI**. **Failure policy:** stop on first failure. Does **not** replace **Unity** **Pre-commit** or reimplement **TECH-50**. Optional before **`project-spec-close`** step 8 when work touched **MCP** / **schemas** / index sources. Shipped **TECH-52** (completed). | [`.github/workflows/ia-tools.yml`](../../.github/workflows/ia-tools.yml), `AGENTS.md`, [`docs/mcp-ia-server.md`](../../docs/mcp-ia-server.md), [`BACKLOG.md`](../../BACKLOG.md) **§ Completed** **TECH-52** |
