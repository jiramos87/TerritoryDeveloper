...
**Related:** **[`project-spec-implement`](../project-spec-implement/SKILL.md)** (optional **phase exit**); **[`close-dev-loop`](../close-dev-loop/SKILL.md)** (**Moore** **before/after** — **compose**, do not duplicate); **[`ide-bridge-evidence`](../ide-bridge-evidence/SKILL.md)**; **[`bridge-environment-preflight`](../bridge-environment-preflight/SKILL.md)**; **[`project-implementation-validation`](../project-implementation-validation/SKILL.md)** (**`validate:all`**). **Batch tooling prerequisite (shipped):** **glossary** **Agent test mode batch** — **`npm run unity:testmode-batch`**, [`ARCHITECTURE.md`](../../../ARCHITECTURE.md) **Local verification**, [`tools/fixtures/scenarios/README.md`](../../../tools/fixtures/scenarios/README.md). **Program tracker:** [`projects/TECH-31-agent-scenario-generator-program.md`](../../../projects/TECH-31-agent-scenario-generator-program.md).
