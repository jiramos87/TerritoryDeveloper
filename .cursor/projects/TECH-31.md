...
**Implementation specs (sequential):** [31a — test mode + load](../../projects/TECH-31a-test-mode-and-load.md) → [31b — builder](../../projects/TECH-31b-scenario-builder.md) → [31c — verification](../../projects/TECH-31c-verification-pipeline.md) → [31d — **TECH-82** Phase 1 + metrics](../../projects/TECH-31d-city-metrics-TECH-82-phase1.md) → [31e — MCP](../../projects/TECH-31e-mcp-tool-and-workflows.md).
...
|-------------------|------------|---------------------|--------|
| Reference scenario loads in **test mode** | Unity **UTF** or scripted run | One-command local + optional **CI** | Stage **31a** / **31c**; document driver, args, max **CI** ticks |
