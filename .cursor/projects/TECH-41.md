...
**Parent program:** [TECH-21](TECH-21.md) · **Depends on:** none (**TECH-40** **Phase A** completed — [`BACKLOG.md`](../../BACKLOG.md) **§ Completed**) · **Feeds:** [TECH-42](TECH-42.md)
...
- **TECH-40** (completed — [`BACKLOG.md`](../../BACKLOG.md) **§ Completed**): interchange JSON uses string **`artifact`** and optional **`schema_version`** per [`docs/schemas/README.md`](../../docs/schemas/README.md) and **glossary** **Interchange JSON (artifact)**. Pilot **JSON Schema** for **`geography_init_params`**: `docs/schemas/geography-init-params.v1.schema.json` — align **G4** / **TECH-39** **Zod** field names with that shape when you implement loaders.
