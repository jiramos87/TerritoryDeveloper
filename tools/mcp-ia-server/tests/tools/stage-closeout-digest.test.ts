/**
 * Unit tests: stage_closeout_digest tool — envelope shape + error branches.
 *
 * (Renamed from project_spec_closeout_digest in lifecycle-refactor T7.14 when per-Task
 * closeout was collapsed into Stage-scoped closeout per pair-contract seam #4.)
 *
 * ACs (TECH-403 §7b):
