...
**Purpose:** Support the **JSON program (TECH-21)** (**§ Completed** — [`BACKLOG.md`](../BACKLOG.md); **glossary**; **TECH-40** → **TECH-41** → **TECH-44a** **§ Completed**) and the completed **TECH-44** program (**TECH-44b**/**c** — [`BACKLOG.md`](../BACKLOG.md) **§ Completed** **TECH-44**; **Program extension mapping** [`docs/postgres-interchange-patterns.md`](../docs/postgres-interchange-patterns.md)) with **exploration notes**, a **versioning FAQ**, and **mapping** from ideas to backlog issues. **Not** authoritative game behavior — [`ia/specs/glossary.md`](../ia/specs/glossary.md) and reference specs win. **B1**/**B3**/**P5** norms: [`docs/postgres-interchange-patterns.md`](../docs/postgres-interchange-patterns.md).
...
**Shape (truncated):**  
`{ "artifact": "spec_index", "schema_version": 1, "specs": [ { "key": "persistence-system", "path": "ia/specs/persistence-system.md", "sections": ["save", "load-pipeline"] } ] }`
