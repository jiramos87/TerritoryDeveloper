...
**Prerequisite stages:** **31a** (load path and artifact layout); **31a2** (shipped — **glossary** **Agent test mode batch** for agent smoke on generated saves); **31a3** (**agent-test-mode-verify** skill — optional for builder development but required for the **program** agent workflow before relying on **31b** in unattended loops).
