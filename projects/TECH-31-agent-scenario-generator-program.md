...
**Cursor spec (stub + Open Questions):** [`ia/projects/TECH-31.md`](../ia/projects/TECH-31.md).  
...
| **31d** | **City history** for scenarios: **TECH-82** Phase 1 (`city_metrics_history`, **`MetricsRecorder`**, **`city_metrics_query`**) + **test mode** **`scenario_id`** correlation (see **TECH-82** Decision Log) | *(stage spec removed after IA migration — 2026-04-10)* — **glossary** **City metrics history**, [`ia/projects/TECH-82.md`](../ia/projects/TECH-82.md) (**Phase 1**), [`docs/mcp-ia-server.md`](../docs/mcp-ia-server.md) (**`city_metrics_query`**), [`tools/fixtures/scenarios/README.md`](../tools/fixtures/scenarios/README.md), **managers-reference** (**MetricsRecorder**) | **TECH-82** (Phases 2–4 still open); **TECH-31** consumes |
...
- Stub **Test contracts** in [`ia/projects/TECH-31.md`](../ia/projects/TECH-31.md) lists batch driver args, **CI** tick bound, and points to **31c** for normative tables.
...
| 2026-04-10 | **31d** complete: **`city_metrics_history`**, **`MetricsRecorder`**, **`city_metrics_query`**, **`scenario_id`** for **test mode**; docs + fixtures **README** + **agent-test-mode-verify** skill; stage spec removed — trace **glossary** **City metrics history** + **TECH-82** Phase 1 | [`ia/projects/TECH-82.md`](../ia/projects/TECH-82.md) |
