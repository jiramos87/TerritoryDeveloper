...
**TECH-18–21** → **B–C** depending on milestone; **TECH-20** (Unity context doc) is a strong **B** for *documentation-only* increments.
...
| TECH-20 slice milestones | [**TECH-25**](../BACKLOG.md#code-health-technical-debt) (see also [**TECH-20**](../BACKLOG.md#low-priority) for the umbrella doc) |
...
3. **TECH-20 slices** — Author `unity-development-context.md` in small PRs (lifecycle, SerializeField policy, `FindObjectOfType` policy, execution order). Each PR is **A** for an agent with `spec_section` alignment to `coding-conventions.mdc`. **→ [TECH-25](../BACKLOG.md#code-health-technical-debt)** (milestones); acceptance and spec file remain **[TECH-20](../BACKLOG.md#low-priority)**.
