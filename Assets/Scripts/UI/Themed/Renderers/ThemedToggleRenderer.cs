...
namespace Territory.UI.Themed.Renderers
{
    ...
    /// </summary>
    /// <remarks>TECH-32929 Stage 6.0 — Quarantined alongside ThemedToggle.</remarks>
    [Obsolete("ThemedToggleRenderer quarantined (TECH-32929). Deletion deferred to uGUI purge plan.")]
