...
public class ZoneAttributes
{
    ...
    public ZoneAttributes(int constructionCost, int population, int happiness, int powerConsumption, int waterConsumption = 0, int jobsProvided = 0)
    {
    ...
    public static readonly ZoneAttributes ResidentialLightZoning = new ZoneAttributes(2, 0, 0, 0, 0, 0);
    public static readonly ZoneAttributes ResidentialMediumZoning = new ZoneAttributes(4, 0, 0, 0, 0, 0);
    public static readonly ZoneAttributes ResidentialHeavyZoning = new ZoneAttributes(6, 0, 0, 0, 0, 0);
    
    public static readonly ZoneAttributes CommercialLightZoning = new ZoneAttributes(2, 0, 0, 0, 0, 0);
    public static readonly ZoneAttributes CommercialMediumZoning = new ZoneAttributes(4, 0, 0, 0, 0, 0);
    public static readonly ZoneAttributes CommercialHeavyZoning = new ZoneAttributes(7, 0, 0, 0, 0, 0);
    
    public static readonly ZoneAttributes IndustrialLightZoning = new ZoneAttributes(2, 0, 0, 0, 0, 0);
    public static readonly ZoneAttributes IndustrialMediumZoning = new ZoneAttributes(5, 0, 0, 0, 0, 0);
    public static readonly ZoneAttributes IndustrialHeavyZoning = new ZoneAttributes(8, 0, 0, 0, 0, 0);
