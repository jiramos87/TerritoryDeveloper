...
{
    // Overflow implementation extracted from UiBakeHandler.Archetype.cs by Stage 6.0 Tier-D.
    // Thin shell stays in UiBakeHandler.Archetype.cs (≤200 LOC); all logic lives here.
    public static partial class UiBakeHandler
    {
            ...
            out Image haloImage)
        {
            ...
            // Body visual default — rounded 9-slice sprite + cream fill.
            ...
            // icon child — Step 16.D human-art sprite host.
            ...
            else
            {
                ...
                // Re-bake: re-stretch halo to fill parent.
            ...
            // Ensure render order: body (back) → icon → halo (front).
            ...
            UiTheme theme)
        {
            ...
            // Stage 13.2 — IlluminatedButtonRenderer owns hover/press visuals. Disable Selectable transition.
        ...
        /// <summary>Bake one ThemedOverlayToggleRow IR row into a typed prefab.</summary>
        ...
        /// <summary>Emit slot-wrapper GameObjects for a <see cref="PanelSnapshotItem"/> based on panel slug.</summary>
        ...
        /// <summary>Build hud-bar zone wrappers + per-ord parent map.</summary>
        ...
        /// <summary>Create a zone-level HLG wrapper under <paramref name="parent"/>. Used for Left + Right zones of hud-bar.</summary>
        ...
        /// <summary>Create a zone-level VLG wrapper. Center zone of hud-bar stacks readouts top-to-bottom.</summary>
        ...
        /// <summary>Configure a sub-wrapper RectTransform — fit-to-content, no anchor stretch.</summary>
        ...
        static BakeError BakeSubtypePickerStrip(IrInteractive irRow, string assetPath, UiTheme theme)
        {
            ...
            try
            {
                ...
                arrowLeft.AddComponent<UnityEngine.UI.Button>();
                ...
                arrowRight.AddComponent<UnityEngine.UI.Button>();
