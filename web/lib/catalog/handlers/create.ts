...
import { createPanelSpine, type CatalogPanelCreateBody } from "@/lib/catalog/panel-spine-repo";
...
export async function createCatalogEntity(
  ...
  switch (kind) {
    ...
    case "button":
      return createButtonSpine(body as CatalogButtonCreateBody, sql);
    case "panel":
      return createPanelSpine(body as CatalogPanelCreateBody, sql);
    case "token":
      return createTokenSpine(body as CatalogTokenCreateBody, sql);
    case "archetype":
      return createArchetype(body as CreateArchetypeBody, sql);
    case "pool":
      return createPoolSpine(body as CatalogPoolCreateBody, sql);
    case "audio":
