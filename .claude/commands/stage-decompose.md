...
> 6. **Phase 4** — Call `stage_body_write(slug, stage_id, body_md)` with full Task table + 4 pending subsections (§Stage File Plan · §Plan Fix · §Stage Audit · §Stage Closeout Plan); preserve Status `Draft`.
