...
**See also:** MCP **Bridge export sugar tools** (**`unity_export_cell_chunk`**, **`unity_export_sorting_debug`**) — [`docs/mcp-ia-server.md`](../../docs/mcp-ia-server.md) (**Bridge export sugar tools**).
