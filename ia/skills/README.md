...
Copy-paste stub (no frontmatter): [`ia/templates/project-spec-review-prompt.md`](../templates/project-spec-review-prompt.md). **§Plan Author** (Stage-bulk spec enrichment) authoritative in **`plan-author/SKILL.md`**; **implementation** in **`project-spec-implement/SKILL.md`**; **post-implementation Node checks** in **`project-implementation-validation/SKILL.md`**; **agent test-mode** batch/bridge loop in **`agent-test-mode-verify/SKILL.md`**; optional **Unity** log/screenshot bridge in **`ide-bridge-evidence/SKILL.md`**; **Close Dev Loop** before/after **`debug_context_bundle`** in **`close-dev-loop/SKILL.md`**; **Stage-scoped closeout pair** authoritative in **`stage-closeout-plan/SKILL.md`** + **`plan-applier/SKILL.md`** (Mode stage-closeout); **new issue + spec stub** in **`project-new/SKILL.md`**.
