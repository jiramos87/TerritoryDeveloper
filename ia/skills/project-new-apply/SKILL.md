...
Build per §Schema. Set `skill: project-new-apply`, `run_date: {YYYY-MM-DD}`, `schema_version: 2026-04-18`.

**Step 3 — Append §Changelog entry**

Append to `## Changelog` section of `ia/skills/project-new-apply/SKILL.md`:
