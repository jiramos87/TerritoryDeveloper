...
Build per §Schema. Set `skill: stage-file-plan`, `run_date: {YYYY-MM-DD}`, `schema_version: 2026-04-18`.

**Step 3 — Append §Changelog entry**

Append to `## Changelog` section of `ia/skills/stage-file-plan/SKILL.md`:
