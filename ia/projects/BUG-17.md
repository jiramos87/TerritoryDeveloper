...
**Related tooling:** [docs/agent-tooling-verification-priority-tasks.md](../../docs/agent-tooling-verification-priority-tasks.md) — [unity-development-context.md](../specs/unity-development-context.md) (lifecycle / execution order); **TECH-28** (completed) — **Territory Developer → Reports** exports under `tools/reports/`.
...
| Related | **BUG-16** (init ordering), **unity-development-context.md** (execution order) |
