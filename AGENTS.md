...
**Umbrella backlog programs** (one charter spec + phased child issues): **[TECH-21](.cursor/projects/TECH-21.md)** — **JSON** schemas, validation, indexes, runtime DTOs (**TECH-40** / **TECH-41** **§ Completed** — **TECH-44a** open); **[TECH-44](.cursor/projects/TECH-44.md)** — **Postgres** + interchange patterns (**TECH-44a** → **TECH-44b** → **TECH-44c**); **[TECH-36](.cursor/projects/TECH-36.md)** — **computational** **compute-lib** + Unity extractions + MCP tools (**TECH-37** → **TECH-38** → **TECH-39**). For **`backlog_issue`**, child rows still have their own **Spec** paths—read the umbrella charter when scope spans multiple phases.
...
1. Prefer **`backlog_issue`** (territory-ia) for the issue id when MCP is enabled; otherwise read `BACKLOG.md`. If the issue is a **child** of **TECH-21**, **TECH-44**, or **TECH-36**, skim the **umbrella** spec (`.cursor/projects/TECH-21.md`, `.cursor/projects/TECH-44.md`, or `TECH-36.md`) for program intent, then open the **child** spec (**TECH-44a** for remaining **TECH-21** Phase C pattern docs — **TECH-40** / **TECH-41** **§ Completed**; **TECH-44b**/**c** for Postgres; or **TECH-37**–**TECH-39** for **compute-lib**).
