...
**Umbrella backlog programs:** **JSON program (TECH-21)** — **§ Completed** — [`BACKLOG.md`](BACKLOG.md) **§ Completed** **TECH-21**; trace in **glossary** **JSON program (TECH-21)**, [`docs/postgres-interchange-patterns.md`](docs/postgres-interchange-patterns.md), [`docs/mcp-ia-server.md`](docs/mcp-ia-server.md), [`ARCHITECTURE.md`](ARCHITECTURE.md) (**TECH-40** / **TECH-41** / **TECH-44a**). **TECH-44** — **Postgres** + interchange patterns (**charter closed** — [`BACKLOG.md`](BACKLOG.md) **§ Completed** **TECH-44**; **E1**–**E3** map [`docs/postgres-interchange-patterns.md`](docs/postgres-interchange-patterns.md) **Program extension mapping**; open follow-ups **TECH-53** / **TECH-54** on **BACKLOG**; **Editor export registry** **TECH-55**/**TECH-55b** **§ Completed**). **Active** charter under `.cursor/projects/`: **[TECH-36](.cursor/projects/TECH-36.md)** — **computational** program (**TECH-37** **§ Completed** — **glossary** **territory-compute-lib (TECH-37)**; **TECH-38** → **TECH-39** open). For **`backlog_issue`**, child rows still have their own **Spec** paths—read the active umbrella charter or durable program docs when scope spans multiple phases.
