...
**Umbrella backlog programs** (charter under `.cursor/projects/` where active): **[TECH-21](.cursor/projects/TECH-21.md)** — **JSON** schemas, validation, indexes, runtime DTOs (**TECH-40** / **TECH-41** / **TECH-44a** **§ Completed** — patterns [`docs/postgres-interchange-patterns.md`](docs/postgres-interchange-patterns.md)); **TECH-44** — **Postgres** + interchange patterns (**charter closed** — [`BACKLOG.md`](BACKLOG.md) **§ Completed** **TECH-44**; **E1**–**E3** map [`docs/postgres-interchange-patterns.md`](docs/postgres-interchange-patterns.md) **Program extension mapping**; open follow-ups **TECH-53** / **TECH-54** on **BACKLOG**; **Editor export registry** **TECH-55**/**TECH-55b** **§ Completed**); **[TECH-36](.cursor/projects/TECH-36.md)** — **computational** **compute-lib** + Unity extractions + MCP tools (**TECH-37** → **TECH-38** → **TECH-39**). For **`backlog_issue`**, child rows still have their own **Spec** paths—read the active umbrella charter or durable program docs when scope spans multiple phases.
...
1. Prefer **`backlog_issue`** (territory-ia) for the issue id when MCP is enabled; otherwise read `BACKLOG.md`. If the issue is a **child** of **TECH-21** or **TECH-36**, skim the **umbrella** spec (`.cursor/projects/TECH-21.md` or `.cursor/projects/TECH-36.md`). For **Postgres** / **TECH-44** program scope (e.g. **TECH-53**, **TECH-54**, **Editor export registry** (**TECH-55**/**TECH-55b** **§ Completed**), or **E1** trace), use [`docs/postgres-interchange-patterns.md`](docs/postgres-interchange-patterns.md) **Program extension mapping (E1–E3)** and [`BACKLOG.md`](BACKLOG.md) **§ Completed** **TECH-44**; **TECH-44c** **E1**: [`docs/postgres-ia-dev-setup.md`](docs/postgres-ia-dev-setup.md). Then open the **child** spec or backlog row. **TECH-37**–**TECH-39** for **compute-lib**; **TECH-21** Phase C patterns — [`docs/postgres-interchange-patterns.md`](docs/postgres-interchange-patterns.md), **TECH-44a** **§ Completed**.
