...
| Water bodies | `WaterManager.cs` | `WaterMap.cs`, `WaterBody.cs`, `WaterBodyType.cs`, `GeographyManager.cs`. **FEAT-37a** / **FEAT-37b** / **FEAT-37c** completed; spec `.cursor/specs/water-system-refactor.md`. Lake shore + cliff stacks + sorting: `.cursor/specs/bugs/cliff-water-shore-sorting.md`; shore defects **BUG-33**; **BUG-39** / **BUG-40** completed 2026-03-24 (cliff placement tunables + foreground-water sort cap on `TerrainManager`). Minimap water **BUG-32** completed; load building sort **BUG-34** + grass under buildings **BUG-35** (both completed 2026-03-22) |
