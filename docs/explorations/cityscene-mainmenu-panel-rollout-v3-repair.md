---
slug: cityscene-mainmenu-panel-rollout-v3-repair
parent_plan_id: null
parent_rationale: >
  Repair extension of cityscene-mainmenu-panel-rollout. v1/v2 shipped PASS but
  Editor QA revealed four structural gaps — wrong-target HUD buttons, live legacy
  GOs, pause-menu theme divergence, canvas z-order bug. v3 fixes all four.
  Gated by ui-bake-pipeline-hardening-v2 Layers 3+5 — v3 cannot ship green
  unless scene-wire-plan drift detector + B.7c/d/e gates pass on every stage commit.
target_version: 1
stages:
  - id: "10.0"
