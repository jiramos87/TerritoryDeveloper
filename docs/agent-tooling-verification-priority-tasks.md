...
| 11 | **TECH-44b — PostgreSQL IA schema** — migrations, seed, minimal read surface for glossary/spec/relationships | Infra | Very high — foundation for durable search and MCP evolution | **Completed (2026-04-03)** — [`BACKLOG.md`](../BACKLOG.md) **§ Completed**; [`docs/postgres-ia-dev-setup.md`](postgres-ia-dev-setup.md), **`db/migrations/`**, **`tools/postgres-ia/`**; patterns [`docs/postgres-interchange-patterns.md`](postgres-interchange-patterns.md) (**TECH-44a** **§ Completed**) |
